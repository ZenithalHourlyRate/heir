#ifndef INCLUDE_ANALYSIS_NOISEANALYSIS_BFV_NOISE_H_
#define INCLUDE_ANALYSIS_NOISEANALYSIS_BFV_NOISE_H_
...
// In BFV world, most noise model just use a single value, either as bound or
// as variance.
class NoiseState {
 public:
  enum NoiseType {
...
#endif  // INCLUDE_ANALYSIS_NOISEANALYSIS_BFV_NOISE_H_
