...
mult_seq_dep_8_bfv_log_files = [
    'mult_seq_dep_8_bfv_symbol_logN14.log',
    'mult_seq_dep_8_bfv_bmcm23_logN14.log',
    'mult_seq_dep_8_bfv_kpz21_logN14.log',
]

mult_seq_indep_8_bfv_log_files = [
    'mult_seq_indep_8_bfv_symbol_logN14.log',
    'mult_seq_indep_8_bfv_bmcm23_logN14.log',
    'mult_seq_indep_8_bfv_kpz21_logN14.log',
]
...
symbol_noise_bounds = analyse_log(
    noise_dep_log14_index_to_value, mult_seq_dep_8_bfv_log_files[0]
)
bmcm23_noise_bounds = analyse_log(
    noise_dep_log14_index_to_value, mult_seq_dep_8_bfv_log_files[1]
)
kpz21_noise_bounds = analyse_log(
    noise_dep_log14_index_to_value, mult_seq_dep_8_bfv_log_files[2]
)

noise_indep_log14_index_to_value = {}
symbol_indep_noise_bounds = analyse_log(
    noise_indep_log14_index_to_value, mult_seq_indep_8_bfv_log_files[0]
)
bmcm23_indep_noise_bounds = analyse_log(
    noise_indep_log14_index_to_value, mult_seq_indep_8_bfv_log_files[1]
)
kpz21_indep_noise_bounds = analyse_log(
    noise_indep_log14_index_to_value, mult_seq_indep_8_bfv_log_files[2]
)
...
bmcm23_noise_bounds_array = process_bounds(False, bmcm23_noise_bounds.items())
...
bmcm23_noise_bounds_array_based = base_line(
    bmcm23_noise_bounds_array, average_indep_noise
)
...
plt.plot(x_axis, bmcm23_noise_bounds_array_based, label='BMCM23', marker='*')
