...
CiphertextT func(PrivateKeyT secretKey, CryptoContextT v0, CiphertextT v1,
  ...
  EvalNoiseBGV(v0, secretKey, v10, "29.53", "v10=ModReduce v9");
  ...
  EvalNoiseBGV(v0, secretKey, v13, "29.53", "v13=ModReduce v12");
  ...
  EvalNoiseBGV(v0, secretKey, v15, "117.54", "v15=EvalMultNoRelin v11, v14");
  const auto& v16 = v0->ModReduce(v15);
  EvalNoiseBGV(v0, secretKey, v16, "62.54", "v16=ModReduce v15");
  const auto& v17 = v0->Relinearize(v16);
  EvalNoiseBGV(v0, secretKey, v17, "62.54", "v17=Relinearize v16");
  ...
  EvalNoiseBGV(v0, secretKey, v19, "29.53", "v19=ModReduce v18");
  ...
  EvalNoiseBGV(v0, secretKey, v24, "83.49", "v24=EvalMultNoRelin v20, v23");
  const auto& v25 = v0->Relinearize(v24);
  EvalNoiseBGV(v0, secretKey, v25, "83.49", "v25=Relinearize v24");
  ...
  EvalNoiseBGV(v0, secretKey, v27, "94.75", "v27=EvalMultNoRelin v17, v26");
