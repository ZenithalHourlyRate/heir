...
CiphertextT func(PrivateKeyT secretKey, CryptoContextT v0, CiphertextT v1,
  ...
  EvalNoiseBGV(v0, secretKey, v10, "v10=ModReduce v9");
  const auto& v11 = v0->Relinearize(v10);
  EvalNoiseBGV(v0, secretKey, v11, "v11=Relinearize v10");
  const auto& v12 = v0->EvalMultNoRelin(v3, v4);
  EvalNoiseBGV(v0, secretKey, v12, "v12=EvalMultNoRelin v3, v4");
  const auto& v13 = v0->ModReduce(v12);
  EvalNoiseBGV(v0, secretKey, v13, "v13=ModReduce v12");
  ...
  EvalNoiseBGV(v0, secretKey, v15, "v15=EvalMultNoRelin v11, v14");
  const auto& v16 = v0->ModReduce(v15);
  EvalNoiseBGV(v0, secretKey, v16, "v16=ModReduce v15");
  ...
  EvalNoiseBGV(v0, secretKey, v18, "v18=EvalMultNoRelin v5, v6");
  const auto& v19 = v0->ModReduce(v18);
  EvalNoiseBGV(v0, secretKey, v19, "v19=ModReduce v18");
  ...
  EvalNoiseBGV(v0, secretKey, v21, "v21=EvalMultNoRelin v7, v8");
  const auto& v22 = v0->Relinearize(v21);
  EvalNoiseBGV(v0, secretKey, v22, "v22=Relinearize v21");
  const auto& v23 = v0->ModReduce(v22);
  EvalNoiseBGV(v0, secretKey, v23, "v23=ModReduce v22");
  const auto& v24 = v0->EvalMultNoRelin(v20, v23);
  EvalNoiseBGV(v0, secretKey, v24, "v24=EvalMultNoRelin v20, v23");
  const auto& v25 = v0->Relinearize(v24);
  EvalNoiseBGV(v0, secretKey, v25, "v25=Relinearize v24");
  const auto& v26 = v0->ModReduce(v25);
  EvalNoiseBGV(v0, secretKey, v26, "v26=ModReduce v25");
  const auto& v27 = v0->EvalMultNoRelin(v17, v26);
  EvalNoiseBGV(v0, secretKey, v27, "v27=EvalMultNoRelin v17, v26");
  const auto& v28 = v0->Relinearize(v27);
  EvalNoiseBGV(v0, secretKey, v28, "v28=Relinearize v27");
  const auto& v29 = v0->ModReduce(v28);
  EvalNoiseBGV(v0, secretKey, v29, "v29=ModReduce v28");
  return v29;
}
...
CiphertextT func__encrypt__arg7(PrivateKeyT secretKey, CryptoContextT v79,
  ...
  EvalNoiseBGV(v79, secretKey, v85, "v85=Encrypt v81, v84");
  return v85;
}
