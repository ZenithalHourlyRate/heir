...
CiphertextT func(PrivateKeyT secretKey, CryptoContextT v0, CiphertextT v1,
  ...
  const auto& v10 = v0->EvalMultNoRelin(v3, v4);
  EvalNoiseBGV(v0, secretKey, v10, "57.96", "v10=EvalMultNoRelin v3, v4");
  const auto& v11 = v0->ModReduce(v9);
  EvalNoiseBGV(v0, secretKey, v11, "29.53", "v11=ModReduce v9");
  const auto& v12 = v0->Relinearize(v11);
  EvalNoiseBGV(v0, secretKey, v12, "56.58", "v12=Relinearize v11");
  const auto& v13 = v0->ModReduce(v10);
  EvalNoiseBGV(v0, secretKey, v13, "29.53", "v13=ModReduce v10");
  ...
  EvalNoiseBGV(v0, secretKey, v17, "57.96", "v17=EvalMultNoRelin v7, v8");
  const auto& v18 = v0->ModReduce(v16);
  EvalNoiseBGV(v0, secretKey, v18, "29.53", "v18=ModReduce v16");
  const auto& v19 = v0->Relinearize(v18);
  EvalNoiseBGV(v0, secretKey, v19, "56.58", "v19=Relinearize v18");
  const auto& v20 = v0->Relinearize(v17);
  EvalNoiseBGV(v0, secretKey, v20, "57.96", "v20=Relinearize v17");
